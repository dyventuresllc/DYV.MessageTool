...
namespace DYV.MessageTool.EventHandlers.Helpers
{
    public class DataHandler
    {
        ...
        public int InsertTestMessageToQueue(int userArtifactId, int msgArtifactId, string firstName, string emailAddress, string msgSubject, string msgBody)
        {
        ...
        public int InsertAllUsersToQueue(int msgArtifactId, string msgSubject, string msgBody)
        {
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("MsgArtifactID", msgArtifactId));
            parameters.Add(new SqlParameter("Subject", msgSubject));
        ...
        public int InsertActiveUsersToQueue(int msgArtifactId, string msgSubject, string msgBody)
        {
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("MsgArtifactID", msgArtifactId));
            parameters.Add(new SqlParameter("Subject", msgSubject));
        ...
        public int InsertEnabledUsersToQueue(int msgArtifactId, string msgSubject, string msgBody)
        {
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("MsgArtifactID", msgArtifactId));
            parameters.Add(new SqlParameter("Subject", msgSubject));
